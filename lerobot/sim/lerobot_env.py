...
class LerobotEnv(Env):
    ...
    def __init__(
        ...
        #self.model = mujoco.MjModel.from_xml_path(os.path.join(ASSETS_PATH, "lerobot_pick_place_cube.xml"))
        
        self.model = mujoco.MjModel.from_xml_path(os.path.join(os.path.dirname(__file__),"lerobot_pick_place_cube.xml"))
    ...
    def apply_action(self, action):
        ...
        if self.action_mode == "joint":
            target_low = np.array([-3.14158, -3.14158, -3.14158,      -3.14158,  -3.14158, -3.14158])
            target_high = np.array([3.14158,  3.14158,     3.14158, 3.14158, 3.14158,  3.14158])
    ...
    def reset(self, seed=None, options=None):
        ...
        self.target_pos = np.array([-0.2, 0.2, 0.0])
